    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-6 text-center">
          <div className="text-sm font-bold uppercase text-gray-500 mb-2">📱 QR Suivi client</div>
        ...
        <div className="bg-white rounded-2xl border-2 border-primary p-6 text-center">
          <div className="text-sm font-bold uppercase text-primary mb-2">📱 QR Mise à jour agent</div>
